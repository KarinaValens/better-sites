export const home_cards = [
  { id: "1", img: "/media/images/service_sect_card1.webp ", title: "Unique Design", short_text: "Set yourself apart from competitors with a unique website design tailored to your specific business needs.", long_text: "", cta: "/services" },
  {
    id: "2",
    img: "/media/images/service_sect_card2.webp ",
    title: "Care Plan",
    short_text: "Focus on your customers while we manage your website. Let us take care of the technical details, so you can focus in growing your business.",
    long_text: "",
    cta: "/services",
  },
  {
    id: "3",
    img: "/media/images/service_sect_card3.webp",
    title: "Communication",
    short_text: "Connect with your customers like never before. We can help you create a website that communicates your message effectively.",
    long_text: "",
    cta: "/services",
  },
];
...
export const services_cards = [
  {
    id: "1",
    img: "/media/images/card1_services.webp ",
    title: "Hassle Free",
    short_text: "Rest assured that your website is in good hands with us. ",
    long_text:
  ...
  {
    id: "2",
    img: "/media/images/card2_services.webp ",
    title: "Optimized",
    short_text: "Rank higher in search engines.",
    long_text:
      "We take care of everything from routine maintenance to security patches, ensuring your site runs smoothly and is protected from potential threats. This way, you can have peace of mind and focus on other important aspects of your business.",
  },
  {
    id: "3",
    img: "/media/images/card3_services.webp",
    title: "Design",
    short_text: "Our goal is to make your site the best site in your industry.",
    long_text:
      "We take care of everything from routine maintenance to security patches, ensuring your site runs smoothly and is protected from potential threats. This way, you can have peace of mind and focus on other important aspects of your business.",
  },
  {
...
export const steps_cards = [
  { id: "1", number: "1", text: "Ready to get started with your Better Site? Opening an account with us is fast and simple. Sign up now to begin the process.", image: "/media/images/process_step_5.webp" },
  {
    ...
    image: "/media/images/services_1_cta.webp ",
  },
  {
    id: "3",
    number: "3",
